...
#[test]
fn schema_v3_exports_queue_and_validates_required_content() -> Result<()> {
    let (_temporary, core) = fixture()?;
    assert_eq!(core.health()?.schema_version, 3);
...
#[test]
fn opening_v1_database_creates_pre_migration_backup_and_applies_v2_and_v3() -> Result<()> {
...
#[test]
fn opening_v2_database_creates_pre_migration_backup_and_applies_strict_v3() -> Result<()> {
